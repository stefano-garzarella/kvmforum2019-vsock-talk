...
plot [32:] [0:]  'data/vsock-perf-patches-h2g.dat' title "" ps 0, \
                '' using 1:2 title "title 1" with linespoints ls 1, \
                '' using 1:3 title "title 2" with linespoints ls 2, \
                '' using 1:4 title "title 3" with linespoints ls 3, \
                '' using 1:5 title "title 4" with linespoints ls 4
